...
class ImpactorSimulatorGUI:
    ...
    def impactor_dropped(self, event):
        ...
        self.simulator.acceleration_filtered = self.simulator.calculations.bandpass_filter(self.simulator.acceleration, 100, 200000, 16000, 2) # (data, lowcut, highcut, fs, order)
